...
public class MergeValueCountsAggregationFunction
        implements AggregationFunction<Map<Object, Long>, Map<Object, Long>> {
    private final Map<Object, Long> valueCounts = new HashMap<>();
    private final DataType inDataType;

    public MergeValueCountsAggregationFunction(DataType inDataType) {
