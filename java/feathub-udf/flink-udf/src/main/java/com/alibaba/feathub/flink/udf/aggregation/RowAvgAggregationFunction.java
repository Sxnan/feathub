...
/** Aggregation function that calculates the average of from Rows with sum and count. */
public class RowAvgAggregationFunction implements AggregationFunction<Row, Double> {

    private final DataType valueType;
    Row avgRow = null;

    public RowAvgAggregationFunction(DataType valueType) {
