...
/** Test for {@link MultiSizeSlidingWindowKeyedProcessFunction}. */
public class MultiSizeSlidingWindowKeyedProcessFunctionTest {
    ...
    void testMultiSlidingWindowSizeProcessFunction() {
        ...
        table =
                MultiSizeSlidingWindowUtils.applyMultiSizeSlidingWindowKeyedProcessFunction(
                        tEnv,
                        table,
                        Arrays.array("id"),
                        "window_time",
                        1000L,
                        AggFieldsDescriptor.builder()
                                .addField(
                                        "val_sum",
                                        DataTypes.BIGINT(),
                                        "val_sum_1",
