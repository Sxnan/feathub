...
/** Test for {@link MinAggregationFunction}. */
class MinAggregationFunctionTest {
    @Test
    void testMinAggregationFunction() {
        final MinAggregationFunction<Integer> aggFunc =
                new MinAggregationFunction<>(DataTypes.INT());
