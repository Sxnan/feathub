...
/** Test for {@link FirstValueAggregationFunction}. */
class FirstValueAggregationFunctionTest {
    @Test
    void tesFirstValueAggregationFunction() {
        final FirstValueAggregationFunction<Integer> aggFunc =
                new FirstValueAggregationFunction<>(DataTypes.INT());
