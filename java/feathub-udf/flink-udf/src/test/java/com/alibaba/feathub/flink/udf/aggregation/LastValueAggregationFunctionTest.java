...
/** Test for {@link LastValueAggregationFunction}. */
class LastValueAggregationFunctionTest {
    @Test
    void testLastValueAggregationFunction() {
        final LastValueAggregationFunction<Integer> aggFunc =
                new LastValueAggregationFunction<>(DataTypes.INT());
