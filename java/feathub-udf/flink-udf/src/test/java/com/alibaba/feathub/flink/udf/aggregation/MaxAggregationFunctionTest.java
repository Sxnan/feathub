...
/** Test for {@link MaxAggregationFunction}. */
class MaxAggregationFunctionTest {
    @Test
    void testMaxAggregationFunction() {
        final MaxAggregationFunction<Integer> aggFunc =
                new MaxAggregationFunction<>(DataTypes.INT());
